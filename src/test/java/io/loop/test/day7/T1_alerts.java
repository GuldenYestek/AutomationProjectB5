...
public class T1_alerts extends TestBase {
    ...
    public void informationAlert() {
        ...
        WebElement clickForJSAlert = driver.findElement(By.xpath("//*[text()='Click for JS Alert']"));
    ...
    public void confirmationAlert() {
        driver.get("https://loopcamp.vercel.app/javascript-alerts.html");
        WebElement clickForJSConfirm = driver.findElement(By.xpath("//*[text()='Click for JS Confirm']"));
    ...
    public void promptAlert() {
        driver.get("https://loopcamp.vercel.app/javascript-alerts.html");
            WebElement clickForJSPrompt = driver.findElement(By.xpath("//*[text()='Click for JS Prompt']"));
