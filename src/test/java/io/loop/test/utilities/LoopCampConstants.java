...
public class LoopCampConstants {
    ...
    public static final String FORGOT_PASSWORD = "https://loopcamp.vercel.app/forgot-password.html";
    ...
    public static final String EXPECTED_HEADER_FORGOT_PASSWORD = "Forgot Password";
