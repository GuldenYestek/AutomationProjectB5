...
public class T5_webTables extends TestBase {
    ...
    public void testwebTables() throws InterruptedException {
        ...
        assertEquals(actualUserName, expectedUserName, "Actual does not match.");
        ...
        assertEquals(actualPhoneNumber, expectedPhoneNumber, "Actual does not match.");

        String expectedRole = "Client";
        String actualRole = DocuportUtils.returnAnyFieldFromTable(driver,"alex.de.souza@gmail.com", "Role");
        assertEquals(actualRole, expectedRole, "Actual does not match.");
        ...
        assertEquals(actualAdvisor, expectedAdvisor, "Actual does not match.");
